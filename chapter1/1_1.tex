...
Table \ref{runtime} shows the solution. We assume the base of $\log(n)$ is 2. And we also assume that there are 30 days in a month and 365 days in a year.\\
...
\begin{tabular}{c|c|c|c|c|c|c|c}
    ...
    $\log(n)$ & $2^{10^6}$ & $2^{10^6 \cdot 60}$ & $2^{10^6 \cdot 60 \cdot 60}$ & $2^{10^6 \cdot 60 \cdot 60 \cdot 24}$ & $2^{10^6 \cdot 60 \cdot 60 \cdot 24 \cdot 30}$ & $2^{10^6 \cdot 60 \cdot 60 \cdot 24 \cdot 365}$ & $2^{10^6 \cdot 60 \cdot 60 \cdot 24 \cdot 365 \cdot 100}$\\\hline
    ...
    $n\log(n)$ & $62,746$ & $2.8 \cdot 10^6$ & $1.33 \cdot 10^8$ & $2.75 \cdot 10^9$ & $7.18 \cdot 10^{10}$ & $7.97 \cdot 10^{11}$ & $6.86 \cdot 10^{13}$\\\hline
